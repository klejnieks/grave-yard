...
define(['models/endpoints', 'models/languages', 'models/countries'], function (Endpoints, Languages, Countries) {
    ...
    app.config = {
     ...
     // White label partner company name
        resources: {
          WLP_CompanyName: {
            en_US: "Avatar Capital Group",
            zh_CN: "Avatar Capital Group",
            es_ES: "Avatar Capital Group",
            pt_BR: "Avatar Capital Group"
          }
        },
        ...
        "companyLogoPath": {
          WLP_Logo: "avatar-logo-dark.svg",
          WLP_Logo_InApp: "avatar-logo-light.svg",
