...
Webview.prototype.add = function(options, success, fail){
...
Webview.prototype.remove = function(options, success, fail){
  if(this.opened){
    cordova.exec(null, null, "Webview", "remove", [options]);
    this.opened = false;
  }
}
